...
def flatten_dict(
    dictionary, parent_key="", separator="_", flatten_lists=False, remove_none=False, keys_to_omit: List[str] = None
):
    ...
    for key, value in dictionary.items():
        ...
        if new_key in keys_to_omit:
            ...
            flattened_dict.update(
                flatten_dict(value, new_key, separator, flatten_lists, remove_none, keys_to_omit=keys_to_omit),
            )
